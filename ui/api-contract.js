...
async function readBuildFile(branchName) {
  ...
  const url = `https://api.github.com/repos/dineshk-wits/ONDC-RET-Specifications/contents/ui/build.js?ref=${branchName}`;
...
async function loadContracts() {
  ...
  const BRANCHES_URL= "https://api.github.com/repos/dineshk-wits/ONDC-RET-Specifications/branches";
  const TAGS_URL= "https://api.github.com/repos/dineshk-wits/ONDC-RET-Specifications/tags";
